...
# Version 8 - Text and PDF files
# Additional functionality to process PDF files as well as text files
# Makes use of UNIX command line program pdftotext and the program runs the command line program using os.system
