...
# Version 6 - Small performance alterations to Version 5
...
print ("I processed %d total files, %d total text lines, and %d total words, of which there were %d different words." % (len(docList),totLineCounter,totWordCounter,uniqWords))
